    ...
    with column2:        
        ...
        # Student Form Page
            ...
            with st.form("student_form"):
                ...
                if st.form_submit_button("Submit"):
                    ...
                    sql = """
                        INSERT INTO students (student_name, dob, email, phone, course, department,graduation_year,password,profile_image)
                        VALUES (?, ?, ?, ?, ?, ?,?,?,?)
                    """
                    profile_image=profile_image.read()
                    data = (student_name,dob,email,phone,course,department,graduation_year,password,profile_image)
        ...
        # Alumni Form Page
            ...
            with st.form("alumni_form"):
                ...
                al_dob=st.date_input("Date of Birth")
                graduation_year = st.number_input("Graduation Year", min_value=1900, max_value=2100, step=1)
