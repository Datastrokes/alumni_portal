...
if ctype=="students.db":
    def authenticate(email, password):
        ...
        cursor.execute("SELECT student_name, dob,email, phone, course, department, graduation_year,profile_image FROM students WHERE email=? AND password=?", (email,password))
